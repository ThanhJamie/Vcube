...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  const navItems = [
    ...
    {
      group: isVi ? 'ĐỊNH GIÁ & BÁO GIÁ' : 'PRICING',
      items: [
        {
          id: 'cost-rules' as AdminNavSection,
          label: isVi ? 'Công Thức Tính Giá' : 'Cost Rules',
          icon: 'calculate',
          badge: 'Inkiri v3.4',
          badgeColor: 'bg-teal-100 text-teal-800 font-tech'
        },
        {
          id: 'materials' as AdminNavSection,
          label: isVi ? 'Nhựa In & Resin' : 'Materials',
          icon: 'layers',
        ...
        },
        {
          ...
          label: isVi ? 'Phụ Kiện & Ốc Cấy' : 'Hardware & Fasteners',
          icon: 'extension',
        ...
        },
        {
          ...
          label: isVi ? 'Báo Giá Dự Toán BOM' : 'Quote Calculator',
          icon: 'request_quote',
          badge: 'BOM Tool',
          badgeColor: 'bg-emerald-100 text-emerald-800 font-tech'
        }
      ]
    },
    {
