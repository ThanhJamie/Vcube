...
export function rowToSiteContent(d: SupabaseRow, defaults: SiteContentConfig): SiteContentConfig {
  return {
    ...
    // Nhóm storefront/SEO nay có CỘT riêng (baseline: alter table site_content ...).
    // Cột rỗng '' = chưa cấu hình ⇒ giữ giá trị defaults (thường là undefined), KHÔNG bịa.
    announcementBadge: d.announcement_badge || defaults.announcementBadge,
    announcementActionText: d.announcement_action_text || defaults.announcementActionText,
    announcementActionTag: d.announcement_action_tag || defaults.announcementActionTag,
    heroHeadlineLine1: d.hero_headline_line1 || defaults.heroHeadlineLine1,
    heroHeadlineHighlight: d.hero_headline_highlight || defaults.heroHeadlineHighlight,
    heroCtaQuoteText: d.hero_cta_quote_text || defaults.heroCtaQuoteText,
    heroCtaCatalogText: d.hero_cta_catalog_text || defaults.heroCtaCatalogText,
    heroMetric1Label: d.hero_metric1_label || defaults.heroMetric1Label,
    heroMetric1Value: d.hero_metric1_value || defaults.heroMetric1Value,
    heroMetric2Label: d.hero_metric2_label || defaults.heroMetric2Label,
    heroMetric2Value: d.hero_metric2_value || defaults.heroMetric2Value,
    heroMetric3Label: d.hero_metric3_label || defaults.heroMetric3Label,
    heroMetric3Value: d.hero_metric3_value || defaults.heroMetric3Value,
    workflowBadge: d.workflow_badge || defaults.workflowBadge,
    workflowTitle: d.workflow_title || defaults.workflowTitle,
    workflowStep1Title: d.workflow_step1_title || defaults.workflowStep1Title,
    workflowStep1Desc: d.workflow_step1_desc || defaults.workflowStep1Desc,
    workflowStep2Title: d.workflow_step2_title || defaults.workflowStep2Title,
    workflowStep2Desc: d.workflow_step2_desc || defaults.workflowStep2Desc,
    workflowStep3Title: d.workflow_step3_title || defaults.workflowStep3Title,
    workflowStep3Desc: d.workflow_step3_desc || defaults.workflowStep3Desc,
    estimatorBadge: d.estimator_badge || defaults.estimatorBadge,
    estimatorTitle: d.estimator_title || defaults.estimatorTitle,
    estimatorSubtitle: d.estimator_subtitle || defaults.estimatorSubtitle,
    estimatorBenefit1: d.estimator_benefit1 || defaults.estimatorBenefit1,
    estimatorBenefit2: d.estimator_benefit2 || defaults.estimatorBenefit2,
    estimatorCtaText: d.estimator_cta_text || defaults.estimatorCtaText,
    trustPartnersTitle: d.trust_partners_title || defaults.trustPartnersTitle,
    trustPartnersList: Array.isArray(d.trust_partners_list) ? d.trust_partners_list : defaults.trustPartnersList,
    seoTitle: d.seo_title || defaults.seoTitle,
    seoDescription: d.seo_description || defaults.seoDescription,
    seoKeywords: d.seo_keywords || defaults.seoKeywords,
    seoOgImage: d.seo_og_image || defaults.seoOgImage,
    seoCanonicalUrl: d.seo_canonical_url || defaults.seoCanonicalUrl,
    seoRobotsIndex: typeof d.seo_robots_index === 'boolean' ? d.seo_robots_index : defaults.seoRobotsIndex,
    seoStructuredData: d.seo_structured_data || defaults.seoStructuredData,
  };
}
