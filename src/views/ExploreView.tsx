  ...
  return (
    <div className="min-h-screen bg-[#F7F6F2] text-[#1C1C1C] py-6 sm:py-10 px-4 sm:px-6 md:px-12 font-sans">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 sm:gap-6 pb-6 border-b border-black/10">
          ...
          <div className="relative w-full md:w-80">
            <input
              ...
              className="w-full pl-9 pr-8 py-2.5 bg-white border border-black/15 text-xs text-[#1C1C1C] placeholder-[#8C857B] focus:outline-none focus:border-[#00687A] rounded shadow-2xs font-sans"
            />
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2.5 top-2.5 text-[#7D7565] hover:text-[#1C1C1C] text-xs p-0.5"
        ...
        <div className="bg-white p-3 sm:p-4 rounded border border-black/10 shadow-2xs space-y-2">
        ...
        <div className="lg:hidden flex items-center justify-between gap-3">
          <button
            ...
            className="flex-1 py-3 px-4 bg-white border border-black/15 text-xs uppercase tracking-wider font-bold flex items-center justify-center gap-2 shadow-2xs rounded"
          >
          ...
          <button
            ...
            className="py-3 px-4 bg-[#EFECE6] border border-black/10 text-xs uppercase tracking-wider text-[#7D7565] rounded font-bold"
          >
            {isVi ? 'Đặt lại' : 'Reset'}
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <aside className={`lg:col-span-3 space-y-6 ${mobileFilterOpen ? 'block' : 'hidden lg:block'}`}>
            <div className="bg-white p-5 sm:p-6 border border-black/10 rounded shadow-2xs space-y-6">
          ...
          <main className="lg:col-span-9 space-y-6">
            ...
            <div className="bg-white p-4 rounded border border-black/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs shadow-2xs">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase font-bold text-[#7D7565]">{t('sortBy', 'Sắp xếp theo:', 'Sort by:')}</span>
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value as any)}
                  className="bg-transparent border border-black/15 py-1.5 px-3 text-xs text-[#1C1C1C] font-bold focus:outline-none focus:border-[#00687A] cursor-pointer rounded"
                >
            ...
            {filteredProducts.length === 0 ? (
              <div className="bg-white p-12 text-center border border-black/10 rounded space-y-4 shadow-2xs">
                ...
                <button
                  onClick={resetFilters}
                  className="px-6 py-2.5 bg-[#00687A] text-white text-xs uppercase font-bold tracking-widest hover:bg-[#005463] transition-colors rounded cursor-pointer"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="bg-white border border-black/10 hover:border-[#00687A] transition-all flex flex-col group p-4 relative rounded shadow-2xs hover:shadow-md"
                    >
                          ...
                          <div className="flex gap-2">
                            ...
                            {product.isCustomizable && (
                              <button
                                ...
                                className="px-3 py-2.5 bg-white border border-black/20 hover:bg-black/5 text-[#1C1C1C] text-[10px] font-sans uppercase tracking-widest transition-colors rounded cursor-pointer"
