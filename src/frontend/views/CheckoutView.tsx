  ...
  return (
    <div className="min-h-screen bg-[#F7F6F2] text-[#1C1C1C] py-6 sm:py-10 px-4 sm:px-6 md:px-12 font-sans">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
        ...
        {isLoggedIn ? (
          <div className="bg-white border border-[#C5C6CD] p-4 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-3 shadow-xs">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-[#EFF4FF] text-[#00687A] flex items-center justify-center font-bold shrink-0">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#545F73]">
                  {isVi
                    ? 'Đơn hàng sẽ tự động liên kết với tài khoản để theo dõi tiến độ in 3D.'
                    : 'Your order will be linked to your account for live print tracking.'}
                </p>
              </div>
            </div>
            <span className="text-[10px] font-mono font-bold px-2.5 py-1 bg-[#EFF4FF] text-[#00687A] rounded uppercase">
          ...
          <div className="bg-white border border-[#C5C6CD] p-4 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-3 shadow-xs">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-xs text-[#091426]">
                  {isVi ? 'Đăng nhập để tích lũy điểm & theo dõi đơn hàng' : 'Sign in to save order history & earn rewards'}
                </p>
                <p className="text-[11px] text-[#545F73]">
                  {isVi
                    ? 'Đăng nhập hoặc đăng ký tài khoản để lưu trữ tệp CAD, xuất hóa đơn VAT và bảo hành bản in.'
                    : 'Sign in or register to store CAD files, download VAT invoices, and track live status.'}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Link
                ...
                className="px-3.5 py-2 bg-[#091426] hover:bg-[#00687A] text-white rounded text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-xs"
              >
              ...
              <Link
                to="/auth/register"
                className="px-3.5 py-2 border border-[#C5C6CD] hover:border-[#00687A] text-[#091426] hover:bg-[#EFF4FF] rounded text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
              >
                <span className="material-symbols-outlined text-sm">person_add</span>
                <span>{isVi ? 'Đăng ký' : 'Sign Up'}</span>
              </Link>
            </div>
          </div>
        )}
